...
export interface ApiAdminInventoryAdminInventory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DeliveryStatus: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiInventoryInventory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    reorderLevel: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    reorderQuantity: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    stockQuantity: Schema.Attribute.BigInteger & Schema.Attribute.Required;
...
export interface ApiOrderDetialOrderDetial extends Struct.CollectionTypeSchema {
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    order_detials: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-detial.order-detial'
    >;
    OrderDate: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    orderDate: Schema.Attribute.Date & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    purchase_detail: Schema.Attribute.Relation<
      'oneToOne',
      'api::purchase-detail.purchase-detail'
    >;
    store: Schema.Attribute.Relation<'manyToOne', 'api::store.store'>;
...
export interface ApiSalesHistorySalesHistory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::sales-history.sales-history'
    > &
      Schema.Attribute.Private;
    products: Schema.Attribute.Relation<'oneToMany', 'api::product.product'>;
    publishedAt: Schema.Attribute.DateTime;
    ...
    store: Schema.Attribute.Relation<'manyToOne', 'api::store.store'>;
    totalSaleAmount: Schema.Attribute.Decimal & Schema.Attribute.Required;
    unitSold: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiStoreStore extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    purchase_orders: Schema.Attribute.Relation<
      ...
      'api::purchase-order.purchase-order'
    >;
    sales_histories: Schema.Attribute.Relation<
      'oneToMany',
      'api::sales-history.sales-history'
    >;
    storeAddress: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::admin-inventory.admin-inventory': ApiAdminInventoryAdminInventory;
      'api::customer.customer': ApiCustomerCustomer;
      'api::inventory.inventory': ApiInventoryInventory;
      'api::order-detial.order-detial': ApiOrderDetialOrderDetial;
      ...
      'api::sales-history.sales-history': ApiSalesHistorySalesHistory;
